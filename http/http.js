...
const body=require('../utils/koa-body3/index');
...
class HttpServer{
    constructor(){
        ...
        this.serverSocket;
        // 引入插件
        this.plugin=require(path.resolve(__dirname,'../utils/plugin/plugin'));
        // 中间件处理
    ...
    middleware(koa){
        ...
        koa.use(body({ 
            ...
            strict:false,
            formidable:{
                uploadDir:path.resolve(__dirname,this.httpConfig.uploadPath||'../public/upload'),
                keepExtensions: true,
